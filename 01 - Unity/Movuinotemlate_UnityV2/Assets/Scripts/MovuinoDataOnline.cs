...
{
    [System.Serializable]
	public class MovuinoDataOnline
	{
        ...
        public MovuinoDataOnline(string adress)
		{
        ...
        private void testEulerLive(Vector3 Gyr, float step)
        {
            angleOrientation = initAngle + step * Gyr;
        }
